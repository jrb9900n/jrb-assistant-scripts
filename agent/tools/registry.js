...
const SA_TOOLS = [
  ...
  },
  {
    ...
    description: 'Set the stop sequence order for jobs already dispatched to the SA dispatch board. Pass the same resource_id and schedule_date used during dispatch, and job_ids as an ordered array (index 0 = stop 1). Call this once after all sa_dispatch_job calls complete for the day.',
    input_schema: {
      type: 'object',
      properties: {
        resource_id:   { type: 'string', description: 'SA resource/crew GUID (same as used in sa_dispatch_job)' },
      ...
      required: ['resource_id', 'schedule_date', 'job_ids'],
    },
  },
  {
