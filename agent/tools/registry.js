...
const TOOL_MAP = {
  ...
  // never be able to merge its own fix; it can only open a PR for Michael to approve.
  auto_fix:   [...CODE_TOOLS.filter(t => t.name !== 'github_merge_pr'), ...FILE_TOOLS, ...TEAMS_TOOLS],
