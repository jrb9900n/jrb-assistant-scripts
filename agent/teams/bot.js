...
4. After ALL jobs are dispatched, call sa_update_route_order once per day+crew with the job_ids in stop order (same order as the draft). This sets the stop sequence on the SA dispatch board.
